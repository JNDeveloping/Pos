...
export function CashLive() {
  ...
  useEffect(() => {
    ...
    const socket = io(window.location.origin, { path: `${base}api/socket.io`, auth: { token: readAccessToken() }, reconnection: true });
